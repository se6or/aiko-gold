      ...
      <div className="relative h-[55vh] min-h-[320px] w-full">
        ...
        {!loading && (
          <button
            ...
            className="absolute bottom-6 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full gold-bg grid place-items-center text-black shadow-gold border-2 border-white/90 hover:scale-110 transition z-10"
            aria-label={t("play")}
          >
